    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/Muhammadtalha678/ai-driven-hackathon/tree/main/frontend/',
        },
        blog: {
